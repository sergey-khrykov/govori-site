const translations = {
  ...
  ru: {
    ...
    feat1_title: 'Быстрый и гибкий поиск',
    feat1_desc: 'Не нужно устанавливать сербскую клавиатуру — достаточно русской или английской. Можно не вводить значки диакритики. Поиск сам понимает, что вы имеете в виду',
    feat2_title: 'Поиск по любой форме или по переводу',
    feat2_desc: 'Ищите слово напрямую или по его английскому или русскому переводу. Работают даже словоформы — не нужно знать исходную форму глагола или существительного, поиск найдёт всё.',
    feat3_title: 'Все падежи, времена и числа',
    feat3_desc: 'Смотрите все формы нужного слова: все времена глагола или падежи существительного, все степени сранения прилагательного – в любом роде и числе.',
    feat4_title: 'Всё важное видно сразу',
    feat4_desc: 'Ударение, род, переходность, стилистический регистр, диалектная принадлежность — все важные данные сразу расположены на видном месте.',
    ...
    feat6_title: 'Быстро перепроверить трудное слово',
    feat6_desc: 'Последние просмотренные слова всегда под рукой. Добавляйте слова в избранное, чтобы больше не искать их.',
    feat7_title: 'Обе письменности на ваш выбор',
    ...
    signup_desc: 'Govori ещё находится в разработке, ноим уже можно пользоваться на iPhone – достаточно скачать через TestFlight. Нажмите на кнопку ниже и проследуйте инструкции. Если у вас не установлен TestFlight, система предложит его скачать. Разработчки будет благодарен вам за сообщения об ошибках и идеи для улучшений.',
