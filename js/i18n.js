...
const translations = {
  en: {
    ...
    pricing_note: 'Prices in US dollars before tax; the App Store and Google Play show them in your local currency, and they may vary with the VAT in your country. Purchases are made inside the app.',
  ...
  ru: {
    ...
    pricing_note: 'Цены в долларах США без налогов; App Store и Google Play показывают их в вашей валюте, и они могут отличаться в зависимости от НДС в вашей стране. Покупка совершается внутри приложения.',
  ...
  'sr-latn': {
    ...
    pricing_note: 'Cene su u američkim dolarima, bez poreza; App Store i Google Play prikazuju ih u vašoj valuti i mogu se razlikovati u zavisnosti od PDV-a u vašoj zemlji. Kupovina se obavlja u aplikaciji.',
  ...
  'sr-cyrl': {
    ...
    plan_monthly_price: '$1.99',
    plan_monthly_per: '/ мес.',
    pricing_note: 'Цене су у америчким доларима, без пореза; App Store и Google Play приказују их у вашој валути и могу се разликовати у зависности од ПДВ-а у вашој земљи. Куповина се обавља у апликацији.',
  ...
  cnr: {
    ...
    pricing_note: 'Cijene su u američkim dolarima, bez poreza; App Store i Google Play prikazuju ih u vašoj valuti i mogu se razlikovati u zavisnosti od PDV-a u vašoj zemlji. Kupovina se obavlja u aplikaciji.',
    pricing_table_heading: 'Šta dobijate',
    pricing_col_free: 'Besplatno',
    pricing_col_plus: 'Plus',
    pricing_trial_chip: 'prvih 14 dana',
  ...
  hr: {
    ...
    plan_monthly_price: '$1.99',
    plan_monthly_per: '/ mj.',
    pricing_note: 'Cijene su u američkim dolarima, bez poreza; App Store i Google Play prikazuju ih u vašoj valuti i mogu se razlikovati ovisno o PDV-u u vašoj zemlji. Kupnja se obavlja u aplikaciji.',
